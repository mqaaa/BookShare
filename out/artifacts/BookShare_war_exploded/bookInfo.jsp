    ...
    <div class="right">
        ...
        <table align="center">
            <form action="bookadd.jsp" method="get">
                <%--<tr><td>BID</td><td><input type="text" name="Uphone"></td></tr>--%>
                <tr><td>Bname</td><td><input type="text" name="Bname"></td></tr>
                <tr><td>URL</td><td><input type="password" name="URL"></td></tr>
                <tr><td>publish</td><td><input type="text" name="publish"></td></tr>
                <tr><td>author</td><td><input type="text" name="author"></td></tr>
                <tr><td>Ptime</td><td><input type="date" name="Ptime"></td></tr>
                <tr><td>Kname</td><td><input type="text" name="Kname"></td></tr>
                <%--<tr><td>Num</td><td><input type="email" name="mail"></td></tr>--%>
