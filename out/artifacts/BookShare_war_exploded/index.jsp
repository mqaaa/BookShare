  ...
  <div class="right">
    ...
    <table align="center" width="95%">
      ...
      <%
        ...
        rs = db.executeQuery("SELECT BID,Bname,book.KID,book.Num,author,Ptime,Kind from book,bookKind where bookKind.KID = book.KID ORDER BY Num DESC  limit "+ info_page +";");
        while (rs.next()){
            String BID =  rs.getString("BID");
            String KID = rs.getString("KID");
            String Bname = rs.getString("Bname");
      ...
      <tr><td align="center">
        <%
          if (page_index != "1"){
              ...
              %><button><a href="index.jsp?info=<%= str%>?page=<%=page_index2%>">上一页</a> </button> <%
          }
...
//            if(q < Integer.parseInt(page_index)*14){
              String page_index2 = Integer.toString(Integer.parseInt(page_index)+1);
          %><button><a href="index.jsp?info=<%= str%>&page=<%=page_index2%>">下一页</a> </button><%
//            }
        %>
