    ...
    <div class="right">
        ...
        <table align="center" width="95%">
            ...
            <%
                ...
                String sql = "SELECT BID,Bname,book.KID,book.Num,author,Ptime,Kind from book,bookKind where bookKind.KID = book.KID AND "+ clas +" like '%"+ find+"%' ORDER BY Num DESC  limit "+ info_page +";";
                %><%= sql%><%
                rs = db.executeQuery("SELECT BID,Bname,book.KID,book.Num,author,Ptime,Kind from book,bookKind where bookKind.KID = book.KID AND "+ clas +" like '%"+ find+"%' ORDER BY Num DESC  limit "+ info_page +";");

//            SELECT BID,Bname,book.KID,book.Num,author,Ptime,Kind from book,bookKind where bookKind.KID = book.KID AND null like '%C%' ORDER BY Num DESC limit 0,13;
        ...
        <table align="center">
            ...
            <tr><td align="center">
                ...
                %><button><a href="find.jsp?clas=<%= clas%>&find=<%= find%>&page=<%=page_index2%>">上一页</a> </button> <%
                }
...
//            if(q < Integer.parseInt(page_index)*14){
                String page_index2 = Integer.toString(Integer.parseInt(page_index)+1);
            %><button><a href="find.jsp?clas=<%= clas%>&find=<%= find%>&page=<%=page_index2%>">下一页</a> </button><%
                //            }
            %>
